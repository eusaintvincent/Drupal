...
(function (Drupal, Backbone, $) {
  ...
  Drupal.editUi.toolbar.ToolbarVisualView = Backbone.View.extend({
    ...
    initialize: function (options) {
      ...
      $('.js-edit-ui__add-block__link', this.$el).each(this.initAjax);
